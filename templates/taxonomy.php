<div class="wrap">
	...
	<ul class="nav nav-tabs">
		<li class="<?php echo !isset($_POST["edit_taxonomy"]) ? 'active' : '' ?>"><a href="#tab-1">Your Taxnomies</a></li>
		<li class="<?php echo isset($_POST["edit_taxonomyt"]) ? 'active' : '' ?>">
			<a href="#tab-2">
